...
const messages = {
    es: {
        ...
        tierlist: {
            ...
            subtitle: 'Consulta una referencia clara de personajes por rol para ayudarte a armar equipos mas fuertes en cualquier etapa del juego.',
    ...
    en: {
        ...
        tierlist: {
            ...
            subtitle: 'Use this easy role-based reference to build stronger teams for both early and endgame content.',
